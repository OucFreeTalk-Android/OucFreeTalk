...
public class GetPersonPosts extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp)
		...
		String selectisFocus = "Select * from friends where focus = " + userId
				+ " and befocus =" + username;
		...
		try {
			...
			String selectUser = "select nikename,pic,introduction from students where id = "
					+ username;
